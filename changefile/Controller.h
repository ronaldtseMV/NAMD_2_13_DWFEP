...
//fepb
      ...
      BigReal bondedEnergyDiff_f_reverse;
      BigReal electEnergy_f;
      BigReal electEnergy_f_reverse;
      BigReal electEnergySlow_f;
      BigReal electEnergySlow_f_reverse;
      BigReal ljEnergy_f;
      BigReal ljEnergy_r;
      BigReal ljEnergy_f_left;  // used by WCA repulsive, [s1,s2]
      BigReal exp_dE_ByRT;
      BigReal exp_dE_reverse_ByRT;
      BigReal dE;
      BigReal dE_reverse;
      BigReal net_dE;
      BigReal net_dE_reverse;
      BigReal dG;
      BigReal dG_reverse;
      int FepNo;
      void printFepMessage(int);
      void printFepMessage_DoubleWide(int);
      BigReal fepSum;
      BigReal fepSum_reverse;
//fepe
...
//fepb
    ...
    void outputFepEnergy_DoubleWide(int step);
    void writeFepEnergyData(int step, ofstream_namd &file);
    void writeFepEnergyData_DoubleWide(int step, ofstream_namd &file);
//fepe
