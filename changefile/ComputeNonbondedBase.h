...
//#endif
  ...
  ALCH(
   ...
   //Doubldwide FEP - For backward direction
    ...
    FEP(BigReal lambda3Up = 0;)
    FEP(BigReal elecLambda3Up = 0;)
    FEP(BigReal vdwLambda3Up = 0;)
    FEP(BigReal vdwShift3Up = 0;)
    FEP(if(simParams->alchDoubleWide)
    {
     lambda3Up = ComputeNonbondedUtil::alchLambda3;
     elecLambda3Up = simParams->getElecLambda(lambda3Up);
     vdwLambda2Up = simParams->getVdwLambda(lambda3Up);
     vdwShift2Up = alchVdwShiftCoeff*(1-vdwLambda3Up);
    }
    )
    ...
    FEP(BigReal lambda3Down = 0;)
    FEP(BigReal elecLambda3Down = 0;)
    FEP(BigReal vdwLambda3Down = 0;)
    FEP(BigReal vdwShift3Down = 0;)

    FEP ( if (simParams->alchDoubleWide) {
	  lambda3Down=1-ComputeNonbondedUtil::alchLambda3;
	  elecLambda3Down=simParams->getElecLambda(lambda3Down);
          vdwLambda3Down = simParams->getVdwLambda(lambda3Down);
          vdwShift3Down = alchVdwShiftCoeff*(1-vdwLambda3Down);
	})
