...
void Controller::outputFepEnergy(int step) {
 if (simParams->alchOn && simParams->alchFepOn) {
  ...
  BigReal dE_reverse = bondedEnergyDiff_f + (electEnergy_f_reverse + electEnergySlow_f_reverse + ljEnergy_r) - (electEnergy + electEnergySlow + ljEnergy);
  //BigReal dE_reverse = (electEnergySlow_f_reverse)- (electEnergySlow);
